...
<div class="publication-section">
    <ul class="publication-details">
        ...
        <li>Chu, H. J., <strong>Lee, J.,</strong> Roh, H. S., & Jeong, C. (2025). Beyond religious tourism: Revolutionizing Templestay as a mental health intervention through wellness tourism. <i>Journal of Travel & Tourism Marketing</i>. (SSCI, Impact factor = 8.2, Current Status = Required Reviews Completed)</li>
        ...
        <li><strong>Lee, J.</strong>, & Jeong, C. (2025). Unveiling the dark side of safari tourism: Negative guide behaviors from tourists’ perspective. <i>Tourism Management Perspectives</i>. (SSCI, Impact factor = 7.3, Current Status = Minor Revision (Prior Status: Minor Revision))</li>
